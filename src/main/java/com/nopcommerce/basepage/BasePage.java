...
public class BasePage {
    ...
    public BasePage() {
        PageFactory.initElements(driver,this);//for page factrory model
        PropertyConfigurator.configure(projectPath + "/src/test/java/resources/propertiesfile/log4j.properties");//for log initialize
    }
